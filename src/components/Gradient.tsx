...
export default function Gradient() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="256px" height="256px" viewBox="0 0 1 1" className="absolute inset-0 rounded-md">
            <defs>
                ...
                <linearGradient id='b' gradientUnits='objectBoundingBox' x1='0' y1='1' x2='1' y2='1'>
                    ...
                    <animateTransform attributeName="gradientTransform" type="rotate" values="360 .5 .5;0 .5 .5" className="ignore"
